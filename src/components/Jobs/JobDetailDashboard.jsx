...
//     if (jobId) {
//       const jobResponse = await axios.get(`http://localhost:5000/api/v1/job/${jobId}`, {
//         headers: {
    ...
    const fetchData = async () => {
      try {
        ...
        if (jobId) {
          ...
          try {
            const candidatesResponse = await axios.get(`http://localhost:5000/api/v1/candidates/job/${jobId}`, {
              headers: {
                'Authorization': `Bearer ${token}`
              }
            });
