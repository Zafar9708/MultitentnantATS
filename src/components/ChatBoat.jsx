...
//       const response = await axios.get('https://9dd19b59bdc6.ngrok-free.app/api/v1/job',{
//         headers:{
...
//     setIsLoading(true);
//     const token = localStorage.getItem('token');
//     const response = await axios.get('https://9dd19b59bdc6.ngrok-free.app/api/v1/candidates', {
//       headers: {
//         Authorization: `Bearer ${token}`
//       }
//     });
...
//     setIsLoading(true);
//     const token = localStorage.getItem('token');
//     const response = await axios.get('https://9dd19b59bdc6.ngrok-free.app/api/v1/interviews/interviews/schedule', {
//       headers: {
//         Authorization: `Bearer ${token}`
//       }
//     });
