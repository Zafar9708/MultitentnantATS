...
//       const response = await axios.get('https://3b0deba4a892.ngrok-free.app/api/v1/job',{
//         headers:{
...
//     setIsLoading(true);
//     const token = localStorage.getItem('token');
//     const response = await axios.get('https://3b0deba4a892.ngrok-free.app/api/v1/candidates', {
//       headers: {
//         Authorization: `Bearer ${token}`
//       }
//     });
...
const AtsChatbot = () => {
  ...
  const fetchOfflineInterviews = async () => {
    try {
      setIsLoading(true);
      const token = localStorage.getItem('token');
      const response = await axios.get('https://3b0deba4a892.ngrok-free.app/api/v1/offline/interviews', {
        headers: {
          Authorization: `Bearer ${token}`,
                  'ngrok-skip-browser-warning': 'true'
