...
//             try {
//                 const stagesResponse = await axios.get('https://f0937721124b.ngrok-free.app/api/v1/stages/all');
//                 setStageOptions(stagesResponse.data);

//                 const rejectionResponse = await axios.get('https://f0937721124b.ngrok-free.app/api/v1/stages/rejection-types');
