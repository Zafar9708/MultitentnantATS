...
//             try {
//                 const stagesResponse = await axios.get('https://ab84e28a52f5.ngrok-free.app/api/v1/stages/all');
//                 setStageOptions(stagesResponse.data);

//                 const rejectionResponse = await axios.get('https://ab84e28a52f5.ngrok-free.app/api/v1/stages/rejection-types');
