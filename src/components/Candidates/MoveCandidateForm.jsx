...
//             try {
//                 const stagesResponse = await axios.get('https://9dd19b59bdc6.ngrok-free.app/api/v1/stages/all');
//                 setStageOptions(stagesResponse.data);

//                 const rejectionResponse = await axios.get('https://9dd19b59bdc6.ngrok-free.app/api/v1/stages/rejection-types');
...
const API_BASE_URL = 'https://9dd19b59bdc6.ngrok-free.app/api/v1';
