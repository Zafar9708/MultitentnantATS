...
//     `https://3b0deba4a892.ngrok-free.app/api/v1/candidates/${id}`,
//     {
//       headers: {
...
//   const response = await axios.get(
//     `https://3b0deba4a892.ngrok-free.app/api/v1/candidates/${id}/stage-history`,
//     {
//       headers: {
//         Authorization: `Bearer ${token}`,
//       },
...
//   const response = await axios.get(
//     `https://3b0deba4a892.ngrok-free.app/api/v1/candidates/download-resume/${id}`,
//     {
//       headers: {
//         Authorization: `Bearer ${token}`,
//       },
...
//   const response = await axios.get(
//     `https://3b0deba4a892.ngrok-free.app/api/v1/candidates/preview-resume/${id}`,
//     {
//       headers: {
//         Authorization: `Bearer ${token}`,
//       },
...
//                       ) : (
//                         <iframe
//                           src={`https://3b0deba4a892.ngrok-free.app/api/v1/candidates/preview-resume/${candidate._id}`}
...
const CandidateDetailsPage = () => {
 ...
 const handlePreviewResume = async () => {
  ...
  const handleShareResume = async (method = 'clipboard') => {
    ...
    const resumeUrl = `https://3b0deba4a892.ngrok-free.app/api/v1/candidates/preview-resume/${id}`;
        ...
        <ResumeContent>
          {candidate?.resume ? (
            isResumeLoading ? (
              ...
              <object
                data={`https://3b0deba4a892.ngrok-free.app/api/v1/candidates/preview-resume/${candidate._id}#toolbar=1&navpanes=0&scrollbar=1`}
                type="application/pdf"
