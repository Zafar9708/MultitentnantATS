...
// // const API_BASE = "https://811f85ba2921.ngrok-free.app/api/v1/offline/interviews";
...
//                             const res = await axios.get("https://811f85ba2921.ngrok-free.app/api/v1/interviews/timezones",{
//                                 headers:{
...
//                         try {
//                             const token=localStorage.getItem('token')
//                             const res = await axios.get("https://811f85ba2921.ngrok-free.app/api/v1/interviews/durations",{
//                                 headers:{
//                                     Authorization:`Bearer ${token}`
//                                 }
//                             });
...
//                         try {
//                             const res = await axios.get("https://811f85ba2921.ngrok-free.app/api/v1/interviewers");
//                             return res.data;
//                         } catch (error) {
...
//                         try {
//                             const res = await axios.get("https://811f85ba2921.ngrok-free.app/api/v1/email-templates");
//                             return res.data;
//                         } catch (error) {
...
//                         try {
//                             const token=localStorage.getItem('token')
//                             const res = await axios.get("https://811f85ba2921.ngrok-free.app/api/v1/offline/interviews/utils/rounds",{
//                                 headers:{
//                                     Authorization:`Bearer ${token}`
//                                 }
//                             });
...
//             setLoading(true);
//             const token=localStorage.getItem('token')
//             const response = await axios.post("https://811f85ba2921.ngrok-free.app/api/v1/interviewers",{
//                 headers:{
//                     Authorization:`Bearer ${token}`
//                 }
//             }, newInterviewer);
...
//             const token=localStorage.getItem('token')
//             const response = await axios.post("https://811f85ba2921.ngrok-free.app/api/v1/offline/interviews/", requestData, {
//                 headers: {
//                     Authorization:`Bearer ${token}`,
...
const ScheduleOfflineInterviewForm = ({ open, onClose, candidate, user }) => {
    ...
    const handleAddInterviewer = async () => {
        ...
        try {
            setLoading(true);
            const token = localStorage.getItem('token');
            const response = await axios.post("https://811f85ba2921.ngrok-free.app/api/v1/interviewers", newInterviewer, {
                headers: {
                    Authorization: `Bearer ${token}`,
                   'ngrok-skip-browser-warning': 'true'
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(
                "https://811f85ba2921.ngrok-free.app/api/v1/offline/interviews/",
                requestData,
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
